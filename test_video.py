...
# python test_video.py --modelname MemSAM --task Breast --ckpt_path /home/gem/yaoheng_breast/MemSAM-main/checkpoints/Breast/MemSAM_11270853_0_0.8035157771511807.pth
args = EasyDict(base_lr=0.0005,
            ...
            modelname='MemSAM',
            n_gpu=1,
            sam_ckpt='/dahuafs/userdata/99309212/OtherProject/2025220/sam_vit_b_01ec64.pth',
            task='Breast',
            vit_name='vit_b',
            enable_memory=True,
...
opt.load_path = '/dahuafs/userdata/99309212/OtherProject/2025220/Model2/Model-main/checkpoints/Breast/MemSAM__99.pth'
...
dice_mean, iou_mean, hd_mean, assd_mean, dices_std, iou_std, hd_std, assd_std, *_ = get_eval(testloader, model, criterion=criterion, loss_f = loss_function, opt=opt, args=args)
