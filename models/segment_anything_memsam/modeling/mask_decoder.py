...
# combined_image_features = image_embeddings + image_pe  # (B, C, H, W)

# # 加载预训练的 ResNet18 模型
# resnet = models.resnet18(pretrained=True)

# # 修改输入通道数
# resnet.conv1 = nn.Conv2d(combined_features.shape[1], 64, kernel_size=7, stride=2, padding=3, bias=False)
...
# # 输入到 ResNet
# output = resnet(combined_features)
